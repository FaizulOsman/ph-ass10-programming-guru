...
const RightSidebar = ({ drawer, handleDrawer }) => {
  ...
  return (
    <div>
      <div
        style={drawer ? { marginTop: "-100%" } : { margin: "0" }}
        className="z-50 bg-primary border-l-2 border-primary border-b-2 p-2 w-72 duration-500 min-h-screen absolute top-0 right-0"
      >
